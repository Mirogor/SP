...
EXPORT _stdcall ReplaceData(DWORD pid, const char* data, size_t len, const char* replacement, size_t replacementLen)//ходим по регионам памяти, проверяем можно ли писать туда, если можно сравниваем строку и заменяем ее
{
